    ...
    <form className={styles.container} action={formAction}>
      ...
      <div className={styles.box}>
        ...
        <input
          ...
          required
        />
        {state?.errors?.emailOrUsername && <div className={styles.error} role="alert">{state.errors.emailOrUsername}</div>}
      </div>
      <div className={styles.box}>
        ...
        <input
          ...
          required
        />
        {state?.errors?.password && <div className={styles.error} role="alert">{state.errors.password}</div>}
      </div>
